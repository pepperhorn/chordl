...
import type { ChordData, SectionData, DisplayDefaults } from "@pepperhorn/chordl-core";
import { resolveDefaults, chordRef } from "@pepperhorn/chordl-core";
...
function ChordRenderer({
  ...
  chord: ChordData;
  resolved: Required<import("@pepperhorn/chordl-core").DisplayDefaults>;
  uiTheme?: string;
  chordIndex: number;
  onVariation?: import("../types").OnVariation;
  renderVariationExtras?: import("../types").RenderVariationExtras;
